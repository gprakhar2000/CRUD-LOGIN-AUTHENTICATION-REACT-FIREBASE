                        ...
                        <tbody> 
                            {
                                dishes.map((dish, index) => (
                                    <tr>
                                        ...
                                        <td>
                                            <Link className="btn btn-primary mr-2" to={`/admin/ViewDish/${dish.id}`}><MdRemoveRedEye /></Link>
                                            <Link className="btn btn-outline-primary mr-2" to={`/admin/EditDish/${dish.id}`}><RiEdit2Fill /></Link>
                                            <Link className="btn btn-danger" onClick={() => deleteDish(dish)}><MdDelete /></Link>
                                        </td>
                                    </tr>
                                ))
                            }
